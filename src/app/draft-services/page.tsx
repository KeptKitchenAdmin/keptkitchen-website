  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F5F3F0' }}>
      ...
      <div className="bg-red-500 text-white text-center py-2 font-bold">
        DRAFT SERVICES PAGE - VERSION 4 - NO YELLOW
      </div>
      ...
      <section className="relative pt-32 pb-12 px-6 min-h-[30vh] flex items-center overflow-hidden">
        <Image
          src="/guillaume-de-germain-f6QoaTtdyGw-unsplash.jpg"
        ...
        <div className="container mx-auto relative z-20">
          <div className="max-w-4xl mx-auto text-center">
            <div className="relative inline-block">
              <h1 className="relative text-5xl md:text-7xl font-serif text-white mb-8 leading-tight tracking-tight px-6 py-3 bg-black/40 rounded-lg whitespace-nowrap">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-12">
              <div className="bg-white border border-warm-taupe/20 rounded-xl p-8 hover:shadow-lg transition-all duration-300">
                <h3 className="text-2xl font-serif font-bold text-espresso mb-6">Private Chef Service Plans & Pricing</h3>
      ...
      <section className="relative" style={{padding: '3rem 1.5rem'}}>
        ...
        <div className="container mx-auto relative z-10">
          <div style={{textAlign: 'center'}}>
            <h2 style={{fontSize: '3rem', fontFamily: 'var(--font-serif)', fontWeight: '300', color: 'white', marginBottom: '2rem', opacity: '0.9', lineHeight: '1.4'}}>
